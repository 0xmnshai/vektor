...
#ifdef __cplusplus
void MEM_lockfree_freeN(
    void *vmemh, vektor::mem_guarded::internal::DestructorType destructor_type);
#endif
void *
MEM_lockfree_dupallocN(const void *vmemh) ATTR_MALLOC ATTR_WARN_UNUSED_RESULT;
void *MEM_lockfree_reallocN_id(void *vmemh, size_t len, const char *str)
    ATTR_MALLOC ATTR_WARN_UNUSED_RESULT ATTR_ALLOC_SIZE(2);
...
void *MEM_lockfree_calloc_arrayN(size_t len, size_t size, const char *str)
    ATTR_MALLOC ATTR_WARN_UNUSED_RESULT ATTR_ALLOC_SIZE(1, 2) ATTR_NONNULL(3);
...
void *MEM_lockfree_malloc_arrayN(size_t len, size_t size, const char *str)
    ATTR_MALLOC ATTR_WARN_UNUSED_RESULT ATTR_ALLOC_SIZE(1, 2) ATTR_NONNULL(3);
#ifdef __cplusplus
void *MEM_lockfree_mallocN_aligned(
    size_t len, size_t alignment, const char *str,
...
#endif
void *MEM_lockfree_malloc_arrayN_aligned(size_t len, size_t size,
                                         size_t alignment, const char *str)
    ATTR_MALLOC ATTR_WARN_UNUSED_RESULT ATTR_ALLOC_SIZE(1, 2) ATTR_NONNULL(4);
void *MEM_lockfree_calloc_arrayN_aligned(size_t len, size_t size,
                                         size_t alignment, const char *str)
    ATTR_MALLOC ATTR_WARN_UNUSED_RESULT ATTR_ALLOC_SIZE(1, 2) ATTR_NONNULL(4);
...
#ifdef __cplusplus
void MEM_guarded_freeN(
    void *vmemh, vektor::mem_guarded::internal::DestructorType destructor_type);
#endif
void *
MEM_guarded_dupallocN(const void *vmemh) ATTR_MALLOC ATTR_WARN_UNUSED_RESULT;
...
void *MEM_guarded_mallocN_aligned(
    ...
    ATTR_MALLOC ATTR_WARN_UNUSED_RESULT ATTR_ALLOC_SIZE(1) ATTR_NONNULL(3);
#endif
void *MEM_guarded_malloc_arrayN_aligned(size_t len, size_t size,
                                        size_t alignment, const char *str)
    ATTR_MALLOC ATTR_WARN_UNUSED_RESULT ATTR_ALLOC_SIZE(1, 2) ATTR_NONNULL(4);
void *MEM_guarded_calloc_arrayN_aligned(size_t len, size_t size,
                                        size_t alignment, const char *str)
    ATTR_MALLOC ATTR_WARN_UNUSED_RESULT ATTR_ALLOC_SIZE(1, 2) ATTR_NONNULL(4);
