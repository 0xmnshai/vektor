...
class VPI_Event : public VPI_IEvent {
 public:
  explicit VPI_Event(VPI_EventType type, VPI_QtWindow *window) : type_(type), window_(window) {}
  ...
  [[nodiscard]] VPI_QtWindow *get_window() const noexcept
  {
    return window_;
  }
 ...
 protected:
  VPI_EventType type_;
  VPI_QtWindow *window_;
  mutable bool consumed_ = false;
};

class VPI_KeyEvent : public VPI_Event {
 public:
  VPI_KeyEvent(VPI_QtWindow *window, VPI_TEventKeyData data)
...
class VPI_MouseMoveEvent : public VPI_Event {
 public:
  VPI_MouseMoveEvent(VPI_QtWindow *window, VPI_TEventCursorData data)
...
class VPI_MouseWheelEvent : public VPI_Event {
 public:
  VPI_MouseWheelEvent(VPI_QtWindow *window, VPI_TEventMouseWheelData data)
...
class VPI_WindowEvent : public VPI_Event {
 public:
  VPI_WindowEvent(VPI_EventType type, VPI_QtWindow *window) : VPI_Event(type, window) {}
};
