...
class PropertySubPanel : public QGroupBox {
 ...
 protected:
  ...
  void create_spin_box_row(
      int row, const QString &label, DragSpinBox *&x, DragSpinBox *&y, DragSpinBox *&z, double step = 0.1)
  {
    ...
    auto create_sb = [&](const QString &text, const QString &color, DragSpinBox *&sb, double sb_step) {
