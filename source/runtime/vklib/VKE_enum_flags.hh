...
#define ENUM_OPERATORS(_enum_type)                                             \
  ...
  [[maybe_unused]] [[nodiscard]] inline constexpr _enum_type operator&(        \
      _enum_type a, ::vektor::BitwiseNotEnumValue<_enum_type> b) {             \
    return (_enum_type)(uint64_t(a) & uint64_t(b.value));                      \
  }                                                                            \
  [[maybe_unused]] [[nodiscard]] inline constexpr ::vektor::                   \
      BitwiseNotEnumValue<_enum_type>                                          \
  ...
  [[maybe_unused]] inline _enum_type &operator&=(                              \
      _enum_type &a, ::vektor::BitwiseNotEnumValue<_enum_type> b) {            \
  ...
  [[maybe_unused]] [[nodiscard]] inline constexpr bool flag_is_set(            \
      _enum_type flags, _enum_type flag_to_test) {                             \
