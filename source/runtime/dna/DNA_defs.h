...
#include "../vklib/VKE_sys_types.hh"
...
#define DNA_DEFINE_CXX_METHODS(class_name)                                     \
  ...
  class_name &operator=(                                                       \
      const dna::internal::ShallowDataConstRef<class_name> ref) {              \
    ...
    return *this;                                                              \
                                                                               ...
                                                                               \
  class_name(const dna::internal::ShallowZeroInitializeTag) : class_name() {   \
...
template <typename T>
inline void shallow_copy_array(T *dst, const T *src, const int64_t size) {
